#!/bin/bash
# Smart UOS static IP setter (DHCP-free safe)

# --- 用户需要修改的部分 ---
IPADDR=#{address}
NETMASK=#{netmask}   # 例如 255.255.255.0
GATEWAY=#{gateway}
DNS1=#{dns1}
DNS2=#{dns2}
# ------------------------
...
# ===== 永久生效 =====
# UOS Desktop/Server 基于 Debian/Ubuntu，可写 /etc/network/interfaces
